...
description: 'An online book rental platform with user-friendly UI, security deposit tracking, and overdue handling.',
      images: [
           {src: 'img/book heave/ba1.png', alt: ''},
        {src: 'img/book heave/bk2.png', alt: ''},
        {src: 'img/book heave/bk3.png', alt: ''},
        {src: 'img/book heave/bk4.png', alt: ''},
        {src: 'img/book heave/bk5.png', alt: ''},
        {src: 'img/book heave/bk6.png', alt: ''},
        {src: 'img/book heave/ba1.png', alt: ''},
        {src: 'img/book heave/ba2.png', alt: ''},
        {src: 'img/book heave/ba3.png', alt: ''},
        {src: 'img/book heave/ba4.png', alt: ''},
        {src: 'img/book heave/ba5.png', alt: ''},
        ]
    },
    portfolioWebsite: {
